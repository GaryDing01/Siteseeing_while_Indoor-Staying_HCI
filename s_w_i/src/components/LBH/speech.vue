<template>
  <div>
    ...
    <div class="right">
      <button id="start_button" @click="startButton(event)">
        <img id="start_img" src="@/assets/mic.gif" alt="Start" />
      </button>
    </div>
    <div id="results">
    ...
    <div class="center">
      <div class="sidebyside" style="text-align: right">
        <button id="copy_button" class="button" @click="copyButton()">
          Copy and Paste
        </button>
      ...
      <div class="sidebyside">
        <button id="email_button" class="button" @click="emailButton()">
          Create Email
        </button>
      ...
      <p></p>
      <div id="div_language">
        <select id="select_language" @change="updateCountry()"></select>
        &nbsp;&nbsp;
